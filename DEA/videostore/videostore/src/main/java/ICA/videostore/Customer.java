package ICA.videostore;

import java.util.*;

public class Customer {
	private String _name;
	private Vector _rentals =new Vector(); // Naam?

	public Customer(String name) {
		_name = name;
	}
	public void addRental(Rental arg) {
		_rentals.addElement(arg); // args?
	}
	public String getName() { // getters en setters onderaan
		return _name; 
	}
	public String statement() { // vage function omschrijving
